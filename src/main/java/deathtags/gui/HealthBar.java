...
public class HealthBar {
    ...
    void RenderOwnPartyMember(PartyMemberData data, int posX, int pN, String p_player) {
        ...
        Minecraft.getInstance().getTextureManager().bindTexture(HEART_TEXTURE);
        ...
        Minecraft.getInstance().getTextureManager().bindTexture(TEXTURE_ICON);
        ...
        if (data.leader) 
        	Minecraft.getInstance().ingameGUI.blit(10, (31 + (30 * (pN + 1))), 0, 18, 9, 9);
        
        fontRender.drawStringWithShadow(str3, 10, 40 + (30 * (pN + 1)), 0xFFFFFF);
    }
    ...
    private void drawHealth(int width, int height, float health, float maxHealth) {
        ...
        for (int i = 0; i < maxHealth / 2; i++) {
            ...
            Minecraft.getInstance().ingameGUI.blit(startX, startY, 16, 0, 9, 9);
            
            if ((int) health > dropletHalf) 
                Minecraft.getInstance().ingameGUI.blit(startX, startY, 52, 0, 9, 9);
            else if ((int) health == dropletHalf)
                Minecraft.getInstance().ingameGUI.blit(startX, startY, 61, 0, 9, 9);
    ...
    private void drawHunger(int width, int height, float health, float maxHealth) {
        ...
        for (int i = 0; i < maxHealth / 2; i++) {
            ...
            Minecraft.getInstance().ingameGUI.blit(startX, startY, 16, 27, 9, 9);
            
            if ((int) health > dropletHalf) 
                Minecraft.getInstance().ingameGUI.blit(startX, startY, 52, 27, 9, 9);
            else if ((int) health == dropletHalf)
                Minecraft.getInstance().ingameGUI.blit(startX, startY, 61, 27, 9, 9);
    ...
    private void drawArmor(int width, int height, float armor) {
        ...
        for (int i = 0; i < armor / 2; i++) {
           ...
           Minecraft.getInstance().ingameGUI.blit(startX, startY, 16, 9, 9, 9);
            
            if ((int) armor > dropletHalf) 
                Minecraft.getInstance().ingameGUI.blit(startX, startY, 34, 9, 9, 9);
            else if ((int) armor == dropletHalf)
                Minecraft.getInstance().ingameGUI.blit(startX, startY, 25, 9, 9, 9);
    ...
    private void drawAbsorption(int width, int height, float armor) {
        ...
        for (int i = 0; i < armor / 2; i++) {
            ...
            if ((int) armor > dropletHalf) 
                Minecraft.getInstance().ingameGUI.blit(startX, startY, 160, 0, 9, 9);
            else if ((int) armor == dropletHalf)
                Minecraft.getInstance().ingameGUI.blit(startX, startY, 169, 0, 9, 9);
